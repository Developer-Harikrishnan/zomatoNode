...
const mongoUrl ="mongodb+srv://dev:dev123@cluster0.l63vw.mongodb.net/zomatoclone?retryWrites=true&w=majority"
...
/*app.get('/restaurant/:id',(req,res) => {
    ...
    db.collection('restaurant').find({state_id:restId}).toArray((err,result) =>{
        if(err) throw err;
        res.send(result)
    })
})*/
